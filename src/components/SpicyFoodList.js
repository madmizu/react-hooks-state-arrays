...
// working with multiple state variables
    ...
    // this new variable returns an array of all foods that match the filterBy state.
    // display the new variable:
      // use the new array instead of the original array when generating "foodList" for the creation of our <li> elements.
